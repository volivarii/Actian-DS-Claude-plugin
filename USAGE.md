...
| `/design-proposal [ticket or request] [--concepts N] [--no-research]` | A reasoned document: the recommendation, what this is for, where this lives today, what comparable products do, the approaches, how they compare, what we are not sure about, why this one |
