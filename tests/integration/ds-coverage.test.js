...
var dsHtmlMap = require("../../plugins/actian-design-system/scripts/lib/renderer.js").dsHtmlMap;
var shared = require("../../plugins/actian-design-system/scripts/lib/shared-constants.js");
...
var MAP = path.join(
  __dirname, "..", "..", "plugins", "actian-design-system", "references", "actian-ux-prototype", "fm-to-ds-map.json",
);
var DS_HTML_MAP = require("../../plugins/actian-design-system/scripts/lib/renderer.js").modulePath(
  "html-renderers/ds-html-map.js",
);
var ANATOMY_DIR = path.join(
  __dirname, "..", "..", "plugins", "actian-design-system", "vendor", "components", "dist", "anatomy",
);
...
// stepper, tooltip, date-input, rich-text, dropdown-select-default,
