...
var SKILL = path.resolve(__dirname, "../../plugins/actian-design-system/skills/actian-ux-prototype/SKILL.md");

/**
 * actian-ux-prototype-push-optin.test.js
 *
 ...
 * - SKILL.md carries a pointer to references/actian-ux-prototype/push-opt-in.md.
 *
 * Scope is deliberately non-overlapping with actian-ux-prototype-preview-ordering.test.js
...
describe("actian-ux-prototype push opt-in contract", function () {
  ...
  it("SKILL.md points to references/actian-ux-prototype/push-opt-in.md", function () {
    // Keyed on a token ABSENT from current SKILL.md so this fails cleanly now
    // and passes after the 4.1 rewrite adds the pointer.
    assert.ok(
      src.includes("references/actian-ux-prototype/push-opt-in.md"),
      "SKILL.md must reference references/actian-ux-prototype/push-opt-in.md " +
