...
var SCHEMA = path.join(__dirname, "..", "..", "plugins", "actian-design-system", "schemas", "proposal-data.schema.json");
var SCHEMAS = [
  SCHEMA,
  path.join(__dirname, "..", "..", "plugins", "actian-design-system", "schemas", "proposal-evaluation.schema.json"),
];
