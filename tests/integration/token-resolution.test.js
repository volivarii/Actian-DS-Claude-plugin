...
var RDIR = path.join(
  __dirname, "..", "..", "plugins", "actian-design-system", "scripts", "renderers", "html-renderers",
);
var CSS_FILES = [
  "flow-renderer.css",
  "render-node.css",
...
CSS_FILES.push(require("../../plugins/actian-design-system/scripts/lib/renderer.js").cssPaths.base);
CSS_FILES.push(require("../../plugins/actian-design-system/scripts/lib/renderer.js").cssPaths.fmBase);
...
// relocation).
JS_FILES.push(
  require("../../plugins/actian-design-system/scripts/lib/renderer.js").modulePath(
