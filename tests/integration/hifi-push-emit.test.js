...
var shared = require(
  path.resolve(__dirname, "..", "..", "plugins", "actian-design-system", "scripts", "lib", "shared-constants.js"),
);
var dst = require(
  path.resolve(
    __dirname, "..", "..", "plugins", "actian-design-system", "scripts", "renderers", "html-renderers", "ds-screen-tree.js",
  ),
);
