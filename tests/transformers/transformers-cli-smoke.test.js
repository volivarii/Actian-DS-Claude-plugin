 ...
 *
 * Run with: node --test tests/transformers/transformers-cli-smoke.test.js
 */
...
var TRANSFORMERS_DIR = path.resolve(
  __dirname, "..", "..", "plugins", "actian-design-system", "scripts", "transformers",
);
var EXAMPLES_DIR = path.resolve(__dirname, "..", "..", "plugins", "actian-design-system", "examples");
