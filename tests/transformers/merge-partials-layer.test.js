...
var SCRIPT = path.resolve(
  __dirname, "../../plugins/actian-design-system/scripts/transformers/merge-partials.js",
);
...
describe("merge-partials --incremental: every id is derived from the screen list", function () {
  var deriveScreenId = require("../../plugins/actian-design-system/scripts/lib/screen-id.js").deriveScreenId;
