...
describe("validate-flow-data", function () {
  ...
  describe("gateConfig.filterFindingsByScope (B-refine.1)", function () {
    var { runGate } = require("../../plugins/actian-design-system/scripts/lib/scope-aware-runner.js");
...
describe("refine pipeline integration (B-refine.2)", function () {
  var fs = require("fs");
  var path = require("path");
  var { deriveScope } = require("../../plugins/actian-design-system/scripts/lib/derive-scope.js");
  var { runGate } = require("../../plugins/actian-design-system/scripts/lib/scope-aware-runner.js");
