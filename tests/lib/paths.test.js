...
const { buildPathsFromManifest } = require("../../plugins/actian-design-system/scripts/lib/paths.js");
...
test("paths.js normalizeVersion strips v-prefix", async (t) => {
  const { normalizeVersion } = require("../../plugins/actian-design-system/scripts/lib/paths.js");
...
test("paths.js verifyVendorIntegrity", async (t) => {
  ...
  const { verifyVendorIntegrity } = require("../../plugins/actian-design-system/scripts/lib/paths.js");
