...
var r = require("../../plugins/actian-design-system/scripts/lib/renderer.js").appearanceRender;
var as = require("../../plugins/actian-design-system/scripts/lib/renderer.js").appearanceStyle;

var ANATOMY_DIR = path.join(__dirname, "../../plugins/actian-design-system/vendor/components/dist/anatomy");
var REGISTRY = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, "../../plugins/actian-design-system/vendor/components/dist/registries/dskit.json"),
    "utf8",
  ),
).components;
