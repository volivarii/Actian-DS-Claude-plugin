...
const RENDERER_PATH = path.join(
  __dirname, "../../plugins/actian-design-system/scripts/renderers/html-renderers/flow-renderer.js",
);
...
const fmHtmlMap = require("../../plugins/actian-design-system/scripts/lib/renderer.js").fmHtmlMap;
const renderNodeModule = require("../../plugins/actian-design-system/scripts/renderers/html-renderers/render-node.js");
const dsHtmlMap = require("../../plugins/actian-design-system/scripts/lib/renderer.js").dsHtmlMap;
const dsScreenTree = require("../../plugins/actian-design-system/scripts/renderers/html-renderers/ds-screen-tree.js");
const mockWindow = {
  fmHtmlMap: fmHtmlMap,
