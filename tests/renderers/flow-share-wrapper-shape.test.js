...
var {
  assembleFlowShare,
} = require("../../plugins/actian-design-system/scripts/renderers/assemble-flow-share.js");

var WRAPPER = path.join(
  __dirname, "..", "..", "plugins", "actian-design-system", "templates", "flow-prototype-wrapper.html",
);
