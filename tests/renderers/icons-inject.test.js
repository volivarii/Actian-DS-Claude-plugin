...
var os = require("os");
var shared = require("../../plugins/actian-design-system/scripts/renderers/assemble-shared.js");
...
test("assembled flow HTML injects window.dsIcons before the renderers", function () {
  ...
  cp.execFileSync(
    NODE,
    [
      path.join(__dirname, "..", "..", "plugins", "actian-design-system", "scripts", "renderers", "assemble-preview.js"),
      dataPath,
      "--type",
      "flow",
      "-o",
...
test("buildDsIconsScript ships the shadowed-slug list alongside the geometry", function () {
  ...
  var doc = require(require("../../plugins/actian-design-system/scripts/lib/paths.js").components.icons.svg);
  assert.deepEqual(
    shadowed,
