...
var skin = require(path.join(__dirname, "..", "..", "plugins", "actian-design-system", "scripts", "renderers", "lofi-skin.js"));
...
describe("lofi-skin", function () {
  ...
  it("runs against the real vendor/tokens/tokens.css: declares the real border/bg families and never leaks a non-fm, non-gray hex", function () {
    var tokensPath = path.join(__dirname, "..", "..", "plugins", "actian-design-system", "vendor", "tokens", "tokens.css");
