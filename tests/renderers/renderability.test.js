...
var R = require(
  path.resolve(__dirname, "..", "..", "plugins", "actian-design-system", "scripts", "renderers", "renderability.js"),
);
var { loadAnatomy } = require("../../plugins/actian-design-system/scripts/lib/renderer.js").anatomyRender;
var fs = require("fs");
