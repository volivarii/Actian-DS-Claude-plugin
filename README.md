...
The companion knows canonical layout patterns (dashboard, detail, browse, creation form, table view, explorer homepage, overlays), the registries (320 DS Kit + 287 FM Kit + 28 Meta Kit components — 81 / 33 / 11 component sets), and the content guidelines. Naming a pattern in your prompt gets you the right skeleton on the first try.
...
- **Component inventory** — 320 DS Kit + 287 FM Kit + 28 Meta Kit components (81 / 33 / 11 sets) — dynamically derived from synced registries
...
| **DS Kit (hi-fi)** | Roboto | 320 DS Kit components (81 sets) | Component briefs, audits, hifi conversion |
