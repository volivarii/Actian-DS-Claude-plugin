...
- `vendor/accessibility/src/NN-<slug>.md` — accessibility checks (per-section files; read 02-color-contrast, 05-focus-keyboard, 06-aria-labels, 12-designer-handoff-checklist for review heuristics)
