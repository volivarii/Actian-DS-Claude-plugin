...
> **DEPRECATED:** Markdown component files (`dskit-components.md`, `fm-components.md`, `meta-kit/components.md`) are no longer generated by Phase 1. JSON registries are the sole output. The formatting rules below are retained for historical reference only.
