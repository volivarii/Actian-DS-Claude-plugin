...
`references/component-brief/`: `data-schema.md` (JSON schema, 9 DS + 5 FM cards), `figma-rules.md` (pitfalls), `playground.md` (explorer), `render-table-tool.md` (renderTable strict tool — used for every table-shaped surface). `references/component-brief/push-patterns.md` (Figma push). `references/ds-rules/quality-tiers.md` (tiers).
