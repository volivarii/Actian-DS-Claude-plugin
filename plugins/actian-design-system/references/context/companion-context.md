...
|---------|-------|------|-----|
| DS Kit | 333 components (73 sets) | Roboto | Full design system, all tokens, 3 themes |
...
| **Form** | 19 | text-input, checkbox, radio, dropdown-select-default, search, toggle, calendar-data-selector |
| **Navigation** | 10 | breadcrumb, side-nav, tabs, global-header, stepper, global-header-account-dropdown, app-switcher-dropdown |
| **Data Display** | 27 | card, table, badge, read-only-tag, interactive-tag, avatar, segmented-control, page-header, toolbar, lineage, line-graph |
| **Feedback** | 10 | alert-banner, toast, empty-state, error-state, loader, spinner, loading-skeleton |
| **Overlays** | 5 | drawer, modal, popover, tooltip-default |
