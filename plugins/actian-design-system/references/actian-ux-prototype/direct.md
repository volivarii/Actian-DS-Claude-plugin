...
No `flow-data.json`. So there is nothing to push to Figma, nothing for `/actian-ux-audit`, and no lo-fi or FatMarker rendering. Two direct runs of one prompt differ in structure.
...
**D3. Provenance.** Write `{project_working_directory}/flows/.direct/run.json`: `{ "skill": "actian-ux-prototype --direct", "feature": "...", "prompt": "<first 200 characters>", "date": "<ISO date>", "duration": "", "model": "...", "pluginVersion": "..." }`. Note the start time.
