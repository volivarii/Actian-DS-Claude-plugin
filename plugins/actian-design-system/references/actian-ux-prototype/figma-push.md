# actian-ux-prototype: Figma push, refine shape and push sequence
...
authoring, and the audit pass) for `actian-ux-prototype`. `skills/actian-ux-prototype/SKILL.md`
...
**REQUIRED:** read `references/actian-ux-prototype/push-opt-in.md` for the full trigger table, the `--no-push` veto rules, and the verbatim Step 7.5 combined gate prompt.
...
`references/actian-ux-prototype/refine.md` for the full detection rules and the
...
**REQUIRED:** read `references/actian-ux-prototype/push-sequence.md` for the full push
