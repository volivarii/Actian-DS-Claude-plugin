...
Rigid JSON schema for component-brief output. Generated by the retired skill's card gate, consumed by HTML and Figma renderers. This is the single source of truth — both renderers produce identical output from this data.
