...
For complete examples, see the deterministic scripts that produce valid specs:
- `scripts/brief-to-spec.js` — component brief specs (9 card types)
- `scripts/flow-to-spec.js` — flow specs (3 chrome modes)
- `scripts/slide-to-spec.js` — presentation specs (5 slide types)
- `references/create-component/figma-spec-builder.md` — component authoring specs
