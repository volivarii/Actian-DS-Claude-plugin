...
- `vendor/components/src/guidelines/*.json` — 85 component guidelines (44 curated + 41 auto-stubs; stubs carry `_stub: true`)
...
- `vendor/accessibility/accessibility.md`, `vendor/content/dist/content.md`
...
- **Content guidelines:** `vendor/content/dist/content.md`
