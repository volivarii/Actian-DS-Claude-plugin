...
/**
 * actian-ux-prototype-gates-text.test.js: The "Frame by use case (S2)" paragraph
 ...
 * named it outright.
 * Run: node --test tests/integration/actian-ux-prototype-gates-text.test.js
 */
...
describe("actian-ux-prototype gates text (use-case default, conditional app inference)", function () {
  var skill = fs.readFileSync(path.join(PLUGIN_ROOT, "skills/actian-ux-prototype/SKILL.md"), "utf8");
