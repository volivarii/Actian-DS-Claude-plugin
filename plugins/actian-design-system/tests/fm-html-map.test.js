...
assert(typeof pvEmpty === 'object' && Object.keys(pvEmpty).length === 0, 'empty string returns {}');

const pvNull = parseVariant(null);
assert(typeof pvNull === 'object' && Object.keys(pvNull).length === 0, 'null returns {}');
...
const btnPrimary = renderFMComponent({ type: 'INSTANCE', ref: 'fmButton', variant: 'Type=Primary, Size=md', props: { Label: 'Save' } });
...
const btnSecondary = renderFMComponent({ type: 'INSTANCE', ref: 'fmButton', variant: 'Type=Secondary, Size=sm', props: { Label: 'Cancel' } });
...
const btnDestructive = renderFMComponent({ type: 'INSTANCE', ref: 'fmButton', variant: 'Type=Destructive, Size=md', props: { Label: 'Delete' } });
assertContains(btnDestructive, 'fm-button--destructive', 'destructive class');

const btnOutline = renderFMComponent({ type: 'INSTANCE', ref: 'fmButton', variant: 'Type=Outline, Size=sm', props: { Label: 'Back' } });
...
const tiDefault = renderFMComponent({ type: 'INSTANCE', ref: 'fmTextInput', variant: 'Type=Default', props: { 'Input Text': 'hello' } });
...
const tiDisabled = renderFMComponent({ type: 'INSTANCE', ref: 'fmTextInput', variant: 'Type=Disabled', props: {} });
...
const ddFilled = renderFMComponent({ type: 'INSTANCE', ref: 'fmDropdown', variant: 'Type=Filled', props: { 'Dropdown Text': 'Option A' } });
...
const ddPlaceholder = renderFMComponent({ type: 'INSTANCE', ref: 'fmDropdown', variant: 'Type=Placeholder', props: {} });
assertContains(ddPlaceholder, 'fm-dropdown--placeholder', 'placeholder dropdown');
...
const si = renderFMComponent({ type: 'INSTANCE', ref: 'fmSearchInput', variant: 'Type=Default', props: { 'Input Text': 'search...' } });
...
const ta = renderFMComponent({ type: 'INSTANCE', ref: 'fmTextArea', variant: 'Content=Empty', props: {} });
...
const cbOn = renderFMComponent({ type: 'INSTANCE', ref: 'fmCheckbox', variant: 'State=On', props: {} });
assertContains(cbOn, 'fm-checkbox--on', 'checkbox on');

const cbOff = renderFMComponent({ type: 'INSTANCE', ref: 'fmCheckbox', variant: 'State=Off', props: {} });
...
const rbOn = renderFMComponent({ type: 'INSTANCE', ref: 'fmRadioButton', variant: 'State=On', props: {} });
assertContains(rbOn, 'fm-radio--on', 'radio on');

const rbOff = renderFMComponent({ type: 'INSTANCE', ref: 'fmRadioButton', variant: 'State=Off', props: {} });
...
const tgOn = renderFMComponent({ type: 'INSTANCE', ref: 'fmToggle', variant: 'State=On', props: {} });
...
const alertSuccess = renderFMComponent({ type: 'INSTANCE', ref: 'fmAlert', variant: 'Type=Success', props: { Message: 'Saved!' } });
...
const alertError = renderFMComponent({ type: 'INSTANCE', ref: 'fmAlert', variant: 'Type=Error', props: {} });
...
const banner = renderFMComponent({ type: 'INSTANCE', ref: 'fmBanner', variant: '', props: { Text: 'Info banner' } });
...
const dialog = renderFMComponent({ type: 'INSTANCE', ref: 'fmDialog', variant: '', props: {} });
...
const stepActive = renderFMComponent({ type: 'INSTANCE', ref: 'fmStepper', variant: 'State=Active', props: { Step: '1' } });
assertContains(stepActive, 'fm-stepper--active', 'active stepper');
assertContains(stepActive, '1', 'step number');

const stepComplete = renderFMComponent({ type: 'INSTANCE', ref: 'fmStepper', variant: 'State=Complete', props: {} });
...
const badgeMd = renderFMComponent({ type: 'INSTANCE', ref: 'fmBadge', variant: 'Size=Medium', props: { Label: '5' } });
assertContains(badgeMd, 'fm-badge--medium', 'medium badge');
assertContains(badgeMd, '5', 'badge text');

const badgeSm = renderFMComponent({ type: 'INSTANCE', ref: 'fmBadge', variant: 'Size=Small', props: {} });
...
const tagFilled = renderFMComponent({ type: 'INSTANCE', ref: 'fmTag', variant: 'Style=Filled', props: { Label: 'Active' } });
assertContains(tagFilled, 'fm-tag--filled', 'filled tag');
assertContains(tagFilled, 'Active', 'tag text');

const tagOutline = renderFMComponent({ type: 'INSTANCE', ref: 'fmTag', variant: 'Style=Outline', props: {} });
...
const chip = renderFMComponent({ type: 'INSTANCE', ref: 'fmChip', variant: '', props: { Label: 'Red' } });
...
const tabOn = renderFMComponent({ type: 'INSTANCE', ref: 'fmTab', variant: 'State=On', props: { Label: 'Users' } });
...
const toastStd = renderFMComponent({ type: 'INSTANCE', ref: 'fmToast', variant: 'Style=Standard', props: { Message: 'Done' } });
...
const empty = renderFMComponent({ type: 'INSTANCE', ref: 'fmEmptyState', variant: '', props: {} });
...
const ph = renderFMComponent({ type: 'INSTANCE', ref: 'fmPlaceholder', variant: 'Type=Label+1line', props: {} });
...
const appHeaderAdmin = renderFMComponent({ type: 'INSTANCE', ref: 'fmAppHeader', variant: 'Type=Administration', props: {} });
...
const appHeaderStudio = renderFMComponent({ type: 'INSTANCE', ref: 'fmAppHeader', variant: 'Type=Studio', props: {} });
...
section('fmSideNavItem');

const navActive = renderFMComponent({ type: 'INSTANCE', ref: 'fmSideNavItem', variant: 'State=On', props: { Label: 'Pipelines' } });
...
const navOff = renderFMComponent({ type: 'INSTANCE', ref: 'fmSideNavItem', variant: 'State=Off', props: { Label: 'Jobs' } });
assertContains(navOff, 'fm-nav-item--off', 'off state');

const navPlaceholder = renderFMComponent({ type: 'INSTANCE', ref: 'fmSideNavItem', variant: 'State=Placeholder', props: {} });
...
assertNotContains(navPlaceholder, 'fm-nav-item__label', 'no label element in placeholder');
...
const pgTitle = renderFMComponent({ type: 'INSTANCE', ref: 'fmPageHeader', variant: 'Type=title only', props: { Title: 'My Page' } });
...
const pgSubtitle = renderFMComponent({ type: 'INSTANCE', ref: 'fmPageHeader', variant: 'Type=title+subtitle', props: { Title: 'Reports', Subtitle: 'All time' } });
...
const iconBtn = renderFMComponent({ type: 'INSTANCE', ref: 'fmIconButtons', variant: 'Type=Primary', props: {} });
...
const spinner = renderFMComponent({ type: 'INSTANCE', ref: 'fmSpinner', variant: '', props: {} });
...
const progress = renderFMComponent({ type: 'INSTANCE', ref: 'fmProgressBar', variant: 'Completion=60%', props: {} });
...
const msdd = renderFMComponent({ type: 'INSTANCE', ref: 'fmMultiSelectDropdown', variant: '', props: { 'Dropdown Text': 'Select...' } });
...
const menuDefault = renderFMComponent({ type: 'INSTANCE', ref: 'fmMenuItem', variant: 'State=Default', props: { Label: 'Edit' } });
assertContains(menuDefault, 'fm-menu-item--default', 'default menu item');
assertContains(menuDefault, 'Edit', 'menu item text');

const menuHover = renderFMComponent({ type: 'INSTANCE', ref: 'fmMenuItem', variant: 'State=Hover', props: {} });
...
const tooltip = renderFMComponent({ type: 'INSTANCE', ref: 'fmTooltip', variant: '', props: { Text: 'More info' } });
...
const rtf = renderFMComponent({ type: 'INSTANCE', ref: 'fmRichTextField', variant: '', props: { 'Input Text': 'Rich content' } });
...
const slider = renderFMComponent({ type: 'INSTANCE', ref: 'fmSlider', variant: 'Progress=40%', props: {} });
...
const unknown = renderFMComponent({ type: 'INSTANCE', ref: 'fmUnknownWidget', variant: '', props: {}, name: 'Widget: Foo' });
...
const xssBtn = renderFMComponent({ type: 'INSTANCE', ref: 'fmButton', variant: 'Type=Primary, Size=md', props: { Label: '<script>alert(1)</script>' } });
