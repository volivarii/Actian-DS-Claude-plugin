...
now carries companion, design-audit, design-proposal and generate-flow.
...
| `agents/parity-analyzer.md` | `retired/agents/parity-analyzer.md` | Named only by component-brief and create-component; generate-flow's parity step has run inline since 2026-04-02 (`2f4be79d`), so nothing live dispatched it. |
