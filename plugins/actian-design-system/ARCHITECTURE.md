...
| `/design-proposal` | `skills/design-proposal/SKILL.md` | (none) | (none) | `templates/proposal-document.html` | `schemas/proposal-data.schema.json` | `references/design-proposal/` | `references/ds-rules/fm-css-reference.md`, `references/context/ux-patterns.md` |
